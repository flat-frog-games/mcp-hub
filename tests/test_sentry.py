...
sse_url = "https://mcp.flatfrog.games/sentry/sse"
...
msg_url = f"https://mcp.flatfrog.games/sentry/messages?sessionId={session_id}"
payload = json.dumps({
    "jsonrpc": "2.0",
    "id": 1,
    "method": "initialize",
...
# keep alive slightly longer to see Sentry response
time.sleep(5)
